...
public:
    ...
    void setupUi(QMainWindow *EncodeGUIMV)
    {
        ...
        SelectInTxtBox->setGeometry(QRect(15, 7, 436, 22));
        ...
        SelectInBttn->setGeometry(QRect(456, 7, 88, 24));
        ...
        HDRMetadataGB->setGeometry(QRect(12, 6, 523, 110));
        ...
        MaxFallNUD->setGeometry(QRect(444, 23, 62, 22));
        ...
        MasterDisplayTxtBox->setGeometry(QRect(102, 51, 404, 21));
        ...
        ColorRangeDD->setGeometry(QRect(408, 15, 97, 22));
        ...
        ColorMatrixDD->setGeometry(QRect(408, 42, 97, 22));
        ...
        ColorPrimariesDD->setGeometry(QRect(408, 97, 97, 22));
        ...
        EnablePreviewCB->setGeometry(QRect(485, 25, 32, 20));
    ...
    void retranslateUi(QMainWindow *EncodeGUIMV)
    {
        ...
        EnablePreviewLabel->setText(QCoreApplication::translate("EncodeGUIMV", "Automatically open live encoding preview window:", nullptr));

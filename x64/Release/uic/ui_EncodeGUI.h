...
public:
    ...
    void setupUi(QMainWindow *EncodeGUIMV)
    {
        ...
        AudioTitleCB->setGeometry(QRect(16, 90, 50, 27));
        ...
        QWidget::setTabOrder(GetVidInfoCB, ColorSpaceCB);
        QWidget::setTabOrder(ColorSpaceCB, OutContainerx264DD);
        ...
        QWidget::setTabOrder(SampleVPXDD, HDRMetadataGB);
        QWidget::setTabOrder(HDRMetadataGB, MaxCllNUD);
        QWidget::setTabOrder(MaxCllNUD, MaxFallNUD);
        QWidget::setTabOrder(MaxFallNUD, MasterDisplayTxtBox);
        QWidget::setTabOrder(MasterDisplayTxtBox, DynamicMetadataBttn);
        QWidget::setTabOrder(DynamicMetadataBttn, DynamicHDRTxtBox);
        QWidget::setTabOrder(DynamicHDRTxtBox, ColorsHDRGB);
        QWidget::setTabOrder(ColorsHDRGB, ColorTransferDD);
        QWidget::setTabOrder(ColorTransferDD, ColorRangeDD);
        QWidget::setTabOrder(ColorRangeDD, ColorMatrixDD);
        QWidget::setTabOrder(ColorMatrixDD, ColorPrimariesDD);
        QWidget::setTabOrder(ColorPrimariesDD, VSTabs);
        ...
        QWidget::setTabOrder(AudioQualityNUD, AddAudioJob);
        QWidget::setTabOrder(AddAudioJob, AudioTitleCB);
